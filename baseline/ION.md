...
Platform enum in the SPA (v1.6608.1: `Y`; previously `U3`, `W` - name changes every release): `Darwin="darwin"`, `Win32="win32"`, `Linux="linux"`. Since v1.28929.0 it lives in a `shared-1-*.js` chunk (v1.32352.1: `shared-1-BVYoxQFl.js`; v1.30096.1: `shared-1-Bq6eQQkr.js`; v1.28929.0: `shared-1-Cu-_PEM9.js`).
...
rg -c 'claudeAppBindings' "$ION/assets/v1/"*.js
