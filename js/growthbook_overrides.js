;/*__CDB_GB_OVERRIDES__*/(function () {
  ...
  var TEMPLATE = [
    ...
    "// Desktop v1.34493.1 is listed below, commented out. Uncomment a line to force",
    ...
    "// release (this list reflects v1.34493.1). If the app misbehaves, empty this",
    "// file first.",
    "{",
    "  // \"activeTheme\": \"mario\",",
    "",
    ...
    "    // \"3673327456\": true, // Cowork VM sizedToHost - host-RAM-tiered VM memory sizing; vmMemoryGB pref still wins (new in v1.32352.1)",
